          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="inc/update.php" method="post">
                ...
                <img src="https://showmarket-api.herokuapp.com/api/uploadImage/get-image/<?php echo $service['img']; ?>" alt="<?php echo $service['name']; ?> Görseli" height="200"></br>                
                <a href="https://showmarket-api.herokuapp.com/api/uploadImage/get-image/<?php echo $service['img']; ?>" class="btn btn-sm btn-neutral">Görüntüle</a>
