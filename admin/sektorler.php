<?php include 'inc/functions.php';
   $all_services = array_reverse(sector_get_all());
?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <title>Sektörler - Showmarket Yönetim</title>
  <!-- Favicon -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="sektor-ekle.php" class="btn btn-sm btn-neutral">Sektör Ekle</a>
            </div>
          </div>
        </div>
      </div>
...
$all_services = array_slice( $all_services, $offset, $limit );
         ...
         for ($i=0; $i < count( $all_services ); $i++) { 
           ...
           <th scope="row">
                      ...
                      <td class="text-right">
                      <a href="sektor-duzenle.php?id='.$all_services[$i]['_id'].'" class="btn btn-sm btn-default">Düzenle</a>
                      <a href="sektor-sil.php?id='.$all_services[$i]['_id'].'" class="btn btn-sm btn-primary">Sil</a>
                    </td> </tr>';
         }
          ?>
