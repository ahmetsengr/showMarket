...
<head>
  ...
  <title>Showmarket Yönetim</title>
  <!-- Favicon -->
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                for ($i=0; $i <= 10; $i++) { 
                  echo '<tr>
                  <th scope="row">'.$bussines_users[$i]['company'].'</th>
                  <td>'.$bussines_users[$i]['sector'].'</td>
                  <td>'.mb_substr($bussines_users[$i]['createdAt'],0,10).'</td> </tr>';
                }
                 ?>
                </tbody>
              </table>
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                for ($i=0; $i <= 10; $i++) { 
                  echo '<tr>
                  <th scope="row">'.$services_all[$i]['companyName'].'</th>
                  <td>'.mb_substr($services_all[$i]['createdAt'],0,10).'</td> </tr>';
                }
                 ?>
