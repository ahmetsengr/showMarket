...
function service_delete($x){
    $s =  curlJson('showmarket-api.herokuapp.com/api/service/'.$x, [
        "id" => $x,
    ], 'DELETE');
    return $s;
}
function sector_delete($x){
    $s =  curlJson('showmarket-api.herokuapp.com/api/sector/'.$x, [
        "id" => $x,
    ], 'DELETE');
    return $s;
}
function category_delete($x){
    $s =  curlJson('showmarket-api.herokuapp.com/api/category/'.$x, [
        "id" => $x,
    ], 'DELETE');
    return $s;
}