...
<head>
  ...
  <title>Kategori Düzenle - Showmarket Yönetim</title>
  <!-- Favicon -->
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">"<?php echo $sector['name']; ?>" Kategorisini Düzenle</h3>
            </div>
            <!-- Light table -->
            <div class="card-body">
              <form action="inc/update.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="x" value="category">
                      </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <img src="https://showmarket-api.herokuapp.com/api/uploadImage/get-image/<?php echo $sector['img']; ?>" alt="<?php echo $sector['name']; ?> Görseli" height="200"></br>                
                <a href="https://showmarket-api.herokuapp.com/api/uploadImage/get-image/<?php echo $sector['img']; ?>" class="btn btn-sm btn-neutral">Görüntüle</a>
